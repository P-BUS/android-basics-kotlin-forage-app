...
class ForageableViewModel(
    ...
    private val _allForageables: LiveData<List<Forageable>> = forageableDao.getForageables().asLiveData()
    val allForageables: LiveData<List<Forageable>> = _allForageables
